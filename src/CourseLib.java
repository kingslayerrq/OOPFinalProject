...
public class CourseLib {
	...
	public static Course titleCourse = new Course("Course ID", "CourseName", "Professor", "Subject", "Credit");  //hardcode for title formatting
	private CourseLib() {
	...
	public ArrayList<Course> getCourseBySubject(String subject) {
		...
		//resultArrayList.add(titleCourse);
		for(Course i:CourseList){
